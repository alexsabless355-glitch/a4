  ...
  <aside class="edtech-utility-bar">
    <div class="container utility-flex">
      ...
      <div class="utility-contact-links">
        ...
        <a href="tel:+18887775845" style="color: var(--accent-emerald-light);">ðŸ“ž +1-888-777-5845</a>
      </div>
    </div>
  </aside>
  ...
  <header class="edtech-header">
    <div class="container header-nav-wrapper">
      <a href="index.php" class="edtech-brand" aria-label="LessonLadder Home">
        <div class="ladder-icon-badge">ðŸªœ</div>
      ...
      <div class="nav-cta-actions">
        <button class="theme-toggle-switch" aria-label="Toggle Interface Theme">âš¡</button>
        <a href="contact.html" class="btn btn-emerald" style="padding: 0.45rem 1.15rem; font-size: 0.82rem;">Schedule Assessment</a>
        <button class="mobile-hamburger" aria-label="Open Navigation Menu">â˜°</button>
      </div>
    </div>
  </header>
    ...
    <section class="hero-console-section">
      <div class="container">
        <div class="hero-split-grid">
          ...
          <!-- Left Column -->
          <div>
            <span class="badge badge-emerald">ðŸ§  Evidence-Based Learning Science</span>
            <h1 class="hero-headline">Climb the Cognitive Ladder from <span class="gradient-word">Recall to Mastery</span></h1>
            <p class="hero-subtitle">
              LessonLadder architects precision pedagogical scaffolding. By harmonizing Sweller's Cognitive Load Theory, Ebbinghaus spaced intervals, and Vygotsky's Zone of Proximal Development, we transform passive study into enduring conceptual breakthroughs.
            </p>
    ...
    <section id="workbench" class="section-wrapper" style="background: var(--bg-surface-alt); border-top: 1px solid var(--border-subtle); border-bottom: 1px solid var(--border-subtle);">
      <div class="container">
        <div class="section-head">
          ...
          <p>Model how daily study duration and spaced repetition intervals dictate long-term memory consolidation and cognitive efficiency.</p>
        </div>

        <div class="simulator-card-box">
          <div class="simulator-controls-row">
            <div class="sim-control">
              <label for="study-time-slider">
                <span>Daily Deliberate Study Time</span>
                <span id="study-time-val" style="color: var(--accent-emerald); font-family: var(--font-mono);">60 Mins / Day</span>
              </label>
              <input type="range" id="study-time-slider" min="15" max="180" step="5" value="60" aria-label="Daily Study Time">
            </div>
        ...
        <div class="bento-lab-grid">
          ...
          <div class="bento-lab-item">
            ...
            <div class="bento-text-pane">
              <span class="badge badge-emerald" style="margin-bottom: 0.5rem;">Memory Dynamics</span>
      ...
      <div class="footer-main-grid">
        <div class="footer-brand-info">
          <div style="display: flex; align-items: center; gap: 0.6rem; margin-bottom: 0.75rem;">
            <span style="font-size: 1.5rem;">ðŸªœ</span>
        ...
        <div class="footer-links-col">
          ...
          <p style="margin-top: 0.75rem; font-size: 0.88rem;">
            ...
            <a href="tel:+18887775845" style="color: var(--accent-emerald-light);">+1-888-777-5845</a>
          </p>
        </div>
      </div>
